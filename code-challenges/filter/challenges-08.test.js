...
const getStatName = (arr, minBaseStat) => getBaseStatGreaterThan(arr, minBaseStat).map(item => item.stat.name);
...
const getCharactersWithoutChildren = (arr) => arr.filter(character => !character.children);
